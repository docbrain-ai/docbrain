...
These results are from running DocBrain against **12,224 real Confluence documents** across 4 engineering spaces. No mocks. No synthetic data. Every test hits the live API.
...
━━━ Pain Point 1: Search Quality ━━━
  ✓ 1.1 Grafana alerting how-to (6 sources, has actionable content)
  ✓ 1.2 ImagePullBackOff troubleshooting (6 sources, 1353 chars)
  ✓ 1.3 Code review process (intent: explain, 6 sources)
  ✓ 1.4 Cross-space database migrations (6 sources)
  ✓ 1.5 Grounding — cites sources for specific commands

━━━ Pain Point 2: Stale Documentation Detection ━━━
  ✓ 2.1 Freshness coverage (12,219 docs scored)
  ✓ 2.2 Score differentiation (fresh=1073, stale=540, outdated=9927)
  ✓ 2.3 All 5 freshness signals present (5/5)
  ✓ 2.4 Per-space freshness works

━━━ Pain Point 3: New Employee Onboarding ━━━
  ✓ 3.1 AI-curated onboarding (SAAS: 8 docs, ENG: 8 docs)
  ✓ 3.2 No deep-spec docs in onboarding (filtered by week-1 persona)
  ✓ 3.3 All onboarding docs have reasons (8/8, 8/8)

━━━ Pain Point 4: Conversational Memory ━━━
  ✓ 4.1 Session created and maintained across turns
  ✓ 4.2 Follow-up maintains deployment context
  ✓ 4.3 Third turn maintains conversation thread

━━━ Pain Point 5: Documentation Gap Analysis ━━━
  ✓ 5.1 Gap detection (19 gaps from 12K docs)
  ✓ 5.2 No duplicate gap labels
  ✓ 5.3 No near-duplicate gap labels (trigram + semantic dedup)
  ✓ 5.4 All gaps have descriptive labels
  ✓ 5.5 All gaps have valid severity (19/19)

━━━ Pain Point 6: AI Draft Quality ━━━
  ✓ 6.1 Drafts grounded in real org docs
  ✓ 6.2 Source citations (7 citations per draft)
  ✓ 6.3 GAP markers present (6 gaps honestly marked)
  ✓ 6.4 Related Documentation section with URLs
  ✓ 6.5 Open Questions section for SME review
  ✓ 6.6 Draft substance (742 words, zero boilerplate)

━━━ Pain Point 7: Source Attribution ━━━
  ✓ 7.1 All answers include source documents (6/6)
  ✓ 7.2 All sources have Confluence URLs (6/6)
  ✓ 7.3 All sources have relevance scores (6/6)
  ✓ 7.4 Feedback loop works

  PASS: 40  |  FAIL: 0  |  WARN: 0  |  Score: 100/100
```

Run it yourself: `./scripts/test-real-world.sh`
