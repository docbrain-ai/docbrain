...
echo "  docbrain --help"
echo ""
echo "Configure ingest sources in config/local.yaml (gitignored):"
echo "  # config/local.yaml"
echo "  ingest:"
echo "    ingest_sources: confluence,github_pr"
echo "  confluence:"
echo "    base_url: https://acme.atlassian.net/wiki"
echo "    api_token: ATATT3x..."
echo ""
echo "Put infrastructure secrets (DATABASE_URL, ANTHROPIC_API_KEY, etc.) in .env."
